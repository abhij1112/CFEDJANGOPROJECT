...
from .views import (
    ...
    recipe_ingrdient_update_hx_view,
...
urlpatterns =[
    ...
    path("hx/<int:parent_id>/ingredient/<int:id>/", recipe_ingrdient_update_hx_view , name='hx-ingredient-detail'),
    path("hx/<int:parent_id>/ingredient/", recipe_ingrdient_update_hx_view , name='hx-ingredient-create'),
